...
const APP_TITLE = "TaskFlow Admin";
const APP_DESCRIPTION = "Administration console for TaskFlow.";
...
export const meta: Route.MetaFunction = () => [
  ...
  {
    name: "keywords",
    content: "project management, administration, task management, agile, scrum, kanban, collaboration",
  },
];
